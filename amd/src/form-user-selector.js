...
define(['jquery', 'core/ajax', 'core/templates'], function($, Ajax, Templates) {
    ...
    return /** @alias module:local_autounsuspend/form-user-selector */ {
        ...
        transport: function(selector, query, success, failure) {
            ...
            promise = Ajax.call([{
                methodname: 'local_autounsuspend_search_users',
                args: {
                    query: query,
                }
            }]);
            ...
            promise[0].then(function(results) {
                ...
                $.each(results.users, function(index, user) {
                    ...
                    promises.push(Templates.render('local_autounsuspend/form-user-selector-suggestion', ctx));
                });
